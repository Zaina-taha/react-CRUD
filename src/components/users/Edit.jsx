...
const navigate=useNavigate();
  ...
  <div className="row flex-nowrap">
    ...
    <form onSubmit={sendData}>
      ...
      <Input errors={errors} id={'username'} value={user.name} type={'text'} title={'UserName'} name={'name'} handleData={handleData}   / >
      <Input errors={errors} id={'useremail'} value={user.email} type={'email'} title={'Email'} name={'email'} handleData={handleData}   / >
      <Input errors={errors} id={'userpassword'} value={user.password} type={'password'} title={'Password'} name={'password'} handleData={handleData}   / >
