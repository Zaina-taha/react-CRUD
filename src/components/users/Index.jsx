  ...
  {users.map((user,index)=>{
    ...
    <React.Fragment key={user._id}>
     <tr>
        ...
        <td className='btn btn-info' ><Link className='text-decoration-none text-info' to={`/user/${user._id}`}>Details</Link></td>
        <td className='btn btn-warning'><Link className='text-decoration-none text-warning' to={`/user/edit/${user._id}`}>Edit</Link></td>
